      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./memer-management.php" aria-expanded="false">
                <span>
      ...
      <div class="container-fluid grey-background">
        <div class="card">
          <div class="card-body" style="font-family:Arial, Helvetica, sans-serif">
            <?php
              include('config.php');
              $sql = "SELECT MaterialContent FROM material WHERE MaterialID = '$materialID'";
              $result = mysqli_query($con, $sql);
              $data = mysqli_fetch_assoc($result);
              $matContent = $data['MaterialContent'];
