<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "GET") {
        ...
        $sql = "SELECT * FROM material WHERE MaterialID = '$matID'";
        ...
        $matContent = $row['MaterialContent'];
    }
    else {
        $id = $_POST['id'];
        $name = $_POST['name'];
        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
                ...
                <form method="post">
                    <input type="hidden" name="id" value="<?php echo $matID; ?>">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="name">Material Name</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="name" value="<?php echo $matName; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label" for="content">Material Content</label>
                        <div class="col-sm-12">
