...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="pt-6 bg-600" id="home">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="assets/img/gallery/hive-buzz-header.png" width="470" alt="hero-header" /></div>
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
              <h4 class="fw-bold font-sans-serif">Fun space to learn English</h4>
              <h1 class="fs-6 fs-xl-7 mb-5">An interactive English language learning space</h1><a class="btn btn-outline-secondary" href="index.php#go-to-courses" role="button">Explore</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="assets/img/gallery/Beginner.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Beginner</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="beginner.html">Introduction to English Language</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="assets/img/gallery/Intermediate.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Intermediate</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="intermediate.html">Building Fluency in English Language</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="assets/img/gallery/Advanced.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Advanced</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="advanced.html">Refining Proficiency in English Language</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section>
        <div class="bg-holder" style="background-image:url(assets/img/gallery/BG_better.jpg);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="assets/img/gallery/personalized learning.png" height="200" alt="..." />
              <h1 class="my-2">::</h1>
              <p class="text-info fw-bold">PERSONALIZED LESSONS</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="assets/img/gallery/track progress.png" height="200" alt="..." />
              <h1 class="my-2">::</h1>
              <p class="text-info fw-bold">TRACK YOUR PROGRESS</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="assets/img/gallery/Reward.png" height="200" alt="..." />
              <h1 class="my-2">::</h1>
              <p class="text-info fw-bold">LEVEL COMPLETION REWARD</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="assets/img/gallery/certification.png" height="200" alt="..." />
              <h1 class="my-2">::</h1>
