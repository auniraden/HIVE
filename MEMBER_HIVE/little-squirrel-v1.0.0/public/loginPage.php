...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block"
            ...
            <div class="container">
                <a class="navbar-brand" href="index.html"><img src="assets/img/gallery/HIVE-logo_Tbg.png" height="45"
                        alt="logo" /></a>
                            ...
                            <div class="card-body p-1 pb-md-7 p-md-3">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                                        ...
                                        <form class="mx-1 mx-md-4" method="post" action="functionMemberPage.php">
                                            ...
                                            <div class="d-flex justify-content-center mx-0 mt-5">
                                                <input class="btn btn-warning btn-lg text-black px-4" type="submit"
                                                    value="Login" />
                                            </div>
                                            <div class="d-flex justify-content-center mx-0 mt-5">
                                                <a href="RegisterPage.php">Not A Member Yet? Sign up</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div
                                        class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                        <img src="assets/img/gallery/signUpImage.png" class="img-fluid"
                                            alt="Sample image" />
                                    </div>
                                </div>
                            </div>
